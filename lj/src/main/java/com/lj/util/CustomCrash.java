...
/**
 * 作者：liujian on 2018/12/18 15:52
...
public class CustomCrash implements Thread.UncaughtExceptionHandler {
    ...
    private static final String CRASH_SAVE_SDPATH = Environment.getExternalStorageDirectory().getAbsolutePath() + "/flx"; //崩溃日志SD卡保存路径
...
//                if (result.equals("1")){
//                    LjLogger.instance.log(TAG,"崩溃日志投递成功...");
//                }else {
//                    LjLogger.instance.log(TAG,"崩溃日志投递失败...");
//                }
//            }
//        }).start();
//    }
